...
The `loading_data_from_smard` DAG runs hourly, loading the **Stromverbrauch: Gesamt (Netzlast)** (total electricity consumption / total grid load) series from SMARD into the `total_consumption` table.