...
ELT pipeline that pulls electricity consumption data from [SMARD](https://www.smard.de/) (the German electricity market data platform) and loads it into Postgres on a schedule, orchestrated by Airflow — plus a small web dashboard for browsing the loaded data.
